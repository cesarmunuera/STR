...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#497b956c#;
   ...
   u00121 : constant Version_32 := 16#928a8705#;
   pragma Export (C, u00121, "ada__text_io__enumeration_auxB");
   u00122 : constant Version_32 := 16#c468c016#;
   pragma Export (C, u00122, "ada__text_io__enumeration_auxS");
   ...
   u00125 : constant Version_32 := 16#46b1f5ea#;
   pragma Export (C, u00125, "system__concat_8B");
   u00126 : constant Version_32 := 16#ccfd1cc3#;
   pragma Export (C, u00126, "system__concat_8S");
   u00127 : constant Version_32 := 16#46899fd1#;
   pragma Export (C, u00127, "system__concat_7B");
   u00128 : constant Version_32 := 16#d33d0a0b#;
   pragma Export (C, u00128, "system__concat_7S");
   u00129 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00129, "system__concat_6B");
   u00130 : constant Version_32 := 16#fd3d7ca6#;
   pragma Export (C, u00130, "system__concat_6S");
   u00131 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00131, "system__concat_5B");
   u00132 : constant Version_32 := 16#a8a4123a#;
   pragma Export (C, u00132, "system__concat_5S");
   u00133 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00133, "system__concat_4B");
   u00134 : constant Version_32 := 16#519e7a34#;
   pragma Export (C, u00134, "system__concat_4S");
   u00135 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00135, "system__concat_3B");
   u00136 : constant Version_32 := 16#248a0db1#;
   ...
   u00139 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00139, "system__img_biuS");
   u00140 : constant Version_32 := 16#cdd5cca1#;
   pragma Export (C, u00140, "system__img_fixed_128S");
   u00141 : constant Version_32 := 16#83d1824d#;
   pragma Export (C, u00141, "system__arith_128B");
   u00142 : constant Version_32 := 16#88cbef47#;
   pragma Export (C, u00142, "system__arith_128S");
   u00143 : constant Version_32 := 16#c580fa16#;
   pragma Export (C, u00143, "system__exn_llliS");
   u00144 : constant Version_32 := 16#2549028f#;
   pragma Export (C, u00144, "system__img_utilB");
   u00145 : constant Version_32 := 16#44802e3b#;
   pragma Export (C, u00145, "system__img_utilS");
   u00146 : constant Version_32 := 16#452f4f0f#;
   pragma Export (C, u00146, "system__img_fixed_32S");
   u00147 : constant Version_32 := 16#3a3869b5#;
   pragma Export (C, u00147, "system__arith_32B");
   u00148 : constant Version_32 := 16#af9af9ed#;
   pragma Export (C, u00148, "system__arith_32S");
   u00149 : constant Version_32 := 16#9448e622#;
   pragma Export (C, u00149, "system__exn_intS");
   u00150 : constant Version_32 := 16#47ae2d21#;
   pragma Export (C, u00150, "system__img_fixed_64S");
   u00151 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00151, "system__arith_64B");
   u00152 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00152, "system__arith_64S");
   u00153 : constant Version_32 := 16#2d8c0d8e#;
   pragma Export (C, u00153, "system__exn_lliS");
   u00154 : constant Version_32 := 16#c90890af#;
   pragma Export (C, u00154, "system__img_lfltS");
   u00155 : constant Version_32 := 16#cafa8775#;
   ...
   u00157 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00157, "system__float_controlS");
   u00158 : constant Version_32 := 16#b684afd1#;
   pragma Export (C, u00158, "system__img_lluS");
   u00159 : constant Version_32 := 16#0be1c959#;
   pragma Export (C, u00159, "system__powten_lfltS");
   u00160 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00160, "system__img_llbS");
   u00161 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00161, "system__img_lliS");
   u00162 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00162, "system__img_lllbS");
   u00163 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00163, "system__img_llliS");
   u00164 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00164, "system__img_lllwS");
   u00165 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00165, "system__img_llwS");
   u00166 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00166, "system__img_wiuS");
   u00167 : constant Version_32 := 16#071824fe#;
   pragma Export (C, u00167, "system__val_enum_8S");
   u00168 : constant Version_32 := 16#8da8c7da#;
   pragma Export (C, u00168, "system__val_fixed_128S");
   u00169 : constant Version_32 := 16#0125f8d5#;
   pragma Export (C, u00169, "system__val_fixed_32S");
   u00170 : constant Version_32 := 16#f6b440a2#;
   pragma Export (C, u00170, "system__val_fixed_64S");
   u00171 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00171, "system__val_intS");
   u00172 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00172, "system__val_unsS");
   u00173 : constant Version_32 := 16#0414e57b#;
   pragma Export (C, u00173, "system__val_lfltS");
   u00174 : constant Version_32 := 16#34ab9f34#;
   pragma Export (C, u00174, "system__exn_lfltS");
   u00175 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00175, "system__val_llliS");
   u00176 : constant Version_32 := 16#f82486d6#;
   pragma Export (C, u00176, "system__val_llluS");
   u00177 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00177, "system__memoryB");
   u00178 : constant Version_32 := 16#76873720#;
